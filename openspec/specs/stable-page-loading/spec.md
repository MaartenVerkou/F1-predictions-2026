# stable-page-loading Specification

## Purpose
Defines stable full-document page loading, shared asset delivery, and header-critical asset behavior for server-rendered navigation.
