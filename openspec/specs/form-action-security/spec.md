# form-action-security Specification

## Purpose
Define shared request-boundary protections for browser-driven state changes, including read-only invite views, CSRF validation, and throttling for sensitive actions.
