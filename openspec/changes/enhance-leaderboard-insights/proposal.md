...
- Add round movers that summarize notable points gained and rank movement since the previous actual snapshot.
...
### New Capabilities
- `leaderboard-insights`: Historical leaderboard trends, focus-set charting, selected-participant insights, round movers, and scored/all question breakdown behavior.
...
- Affected tests: unit coverage for trend/insight data builders and Playwright coverage for the leaderboard chart, selected participant behavior, scored-only breakdown toggle, and round movers.
